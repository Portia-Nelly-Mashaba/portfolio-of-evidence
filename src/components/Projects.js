        ...
        <div className="flex flex-col xl:flex-row gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 lgl:justify-between items-end text-right xl:-ml-16 z-10">
            ...
            <p className="bg-[#112240] text-sm md:text-base p-2 md:p-6 rounded-md">
              ...
              <span className="text-textGreen"> 0-auth</span> and make a payment
              using <span className="text-textGreen">Stripe</span>.
            </p>
        ...
        <div className="flex flex-col xl:flex-row-reverse gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 lgl:justify-between items-end text-right  z-10">
            ...
            <p className="bg-[#112240] text-sm md:text-base p-2 xl:-mr-16 md:p-6 rounded-md">
              With this app, users can easily <span className="text-textGreen">create, view, update, and delete</span>
              recipes. The app's user-friendly interface ensures a seamless
              experience in organizing and accessing <span className="text-textGreen">recipe</span> information.
            </p>
            <ul className="text-xs md:text-sm font-titleFont tracking-wide flex gap-2 md:gap-5 justify-between text-textDark">
              <li>React Js</li>
              <li>Bootstrap</li>
